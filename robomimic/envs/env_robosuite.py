...
class EnvRobocasa(EnvRobosuite):
    """Wrapper class for EnvRobosuite that maps obs keys to match the ones in RoboCasa"""
    def __init__(
        self,
        *args,
        **kwargs,
    ):
        super(EnvRobocasa, self).__init__(*args, **kwargs)
